            ...
            <center>
                <div className="h-screen pt-8">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 px-4">
                        ...
                        <button className="border-2 bg-black font-semibold text-white border-slate-600 px-6 py-4">Visit Place</button>
                        <button className="border-2 border-slate-600 px-6 py-4">Car Inspection</button>
                    </div>
                    <br />
                    ...
                    <Link href="/contact">
                        <div>
                            <button className="border-2 bg-blue-700 font-semibold text-white border-slate-600 px-6 py-4">
                                Make Payment
                            </button>
                        </div>
                    </Link>
